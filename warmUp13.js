...
function toCamelCase(str) {
	var strA = str.split('')
	while(strA.indexOf('-') != -1 || strA.indexOf('_') != -1){
		if(strA.indexOf('-') != -1){
			strA.splice(strA.indexOf('-'), 2, strA[strA.indexOf('-') + 1].toUpperCase())
		}
		if(strA.indexOf('_') != -1) {
			strA.splice(strA.indexOf('_'), 2, strA[strA.indexOf('_') + 1].toUpperCase())
		}
	}
    return strA.join('')
